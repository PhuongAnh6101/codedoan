...
<?php
     ...
     $username = $_SESSION['user'];
        ...
        $sql = "SELECT*FROM  `order-food` JOIN food ON `order-food`.`food_id`=food.id  JOIN bill ON `order-food`.`id_bill` = bill.id WHERE `order-food`.`id_users`='$username' AND bill.status = 'Cancelled' ";
       // echo $sql;
