...
<?php
     ...
     $username = $_SESSION['user'];
        ...
        $sql = "SELECT*FROM  `order-food` JOIN food ON `order-food`.`food_id`=food.id  JOIN bill ON `order-food`.`id_bill` = bill.id WHERE `order-food`.`id_users`='$username' AND bill.status = 'On Delivery' ";
       // echo $sql;
     ...
     <a href="<?php echo URL; ?>logout.php" class="fas fa-sign-in-alt"></a>
     </div>
 </section>
